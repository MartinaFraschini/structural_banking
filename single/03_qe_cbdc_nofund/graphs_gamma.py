...
gamma0_path = path + '0/'
gamma1_path = path + '50/'
gamma2_path = path + '100/'

plot_path = './plot/1gamma/'
...
# Check gamma0
gamma0.iloc[31] = (gamma0.iloc[30] + gamma0.iloc[32]) / 2

# Check gamma2
gamma2.iloc[31] = (gamma2.iloc[30] + gamma2.iloc[32]) / 2
...
# axs[0, 0].plot(rCdelta[31]/1000, gamma0_MA.iloc[31]["deposits"], color='red', marker='o')
